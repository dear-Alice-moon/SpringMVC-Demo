...
<body>
	...
	<div class="form-container">
		...
		<form:form method="POST" modelAttribute="student" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="clo-md-3 control-label" for="dob">Date of birth</label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-label" for="firstAttempt">First Attempt?</label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md3 control-label" for="subjects">Subjects</label>
					<div class="col-md-7">
